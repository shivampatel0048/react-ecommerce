...
import { fetchAllProductsAsync, fetchAllProductsByFiltersAsync, selectAllProducts } from '../productSlice';
...
const sortOptions = [
  ...
  { name: 'Best Rating', thumbnail: '#', current: false },
  { name: 'Newest', thumbnail: '#', current: false },
  { name: 'Price: Low to High', thumbnail: '#', current: false },
  { name: 'Price: High to Low', thumbnail: '#', current: false },
]
const filters = [
  {
    id: 'category',

      ...
      {orders.map((order) => (
        <div>
          <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 className="text-4xl font-bold my-3 text-center tracking-tight text-gray-900">Order #{order.id}</h1>
              ...
              <div
                ...
                <div className="flex min-w-0 gap-x-4">
                  <div className="min-w-0 flex-auto">
                    ...
                    <p className="text-sm leading-6 text-gray-500">{order.selectAddress.pinCode}</p>
                  </div>
                </div>
